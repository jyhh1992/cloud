...
scatter_img = pygame.image.load('img/attack.png')
...
class Character(pygame.sprite.Sprite):
    ...
    def shoot(self):
        if self.shoot_cooldown == 0 and self.ammo > 0 :
            ...
            scatter = Scatter(self.rect.centerx + (0.7*self.rect.size[0] * self.direction), self.rect.centery, self.direction)
...
player = Character('player',200, 200, 1, 5, 100)
